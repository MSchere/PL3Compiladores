...
public class GramProgParser extends Parser {
	...
	public static class AndorContext extends ExprContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof GramProgListener ) ((GramProgListener)listener).enterAndor(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof GramProgListener ) ((GramProgListener)listener).exitAndor(this);
		}
	}
	public static class CompararContext extends ExprContext {
		public List<ExprContext> expr() {
			return getRuleContexts(ExprContext.class);
		}
		public ExprContext expr(int i) {
		...
		public CompararContext(ExprContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof GramProgListener ) ((GramProgListener)listener).enterComparar(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof GramProgListener ) ((GramProgListener)listener).exitComparar(this);
		}
	}
	public static class IncrementarContext extends ExprContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof GramProgListener ) ((GramProgListener)listener).enterIncrementar(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof GramProgListener ) ((GramProgListener)listener).exitIncrementar(this);
		}
	}
	public static class MultContext extends ExprContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof GramProgListener ) ((GramProgListener)listener).enterMult(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof GramProgListener ) ((GramProgListener)listener).exitMult(this);
		}
	}
	public static class SumarContext extends ExprContext {
		public List<ExprContext> expr() {
			return getRuleContexts(ExprContext.class);
		}
		public ExprContext expr(int i) {
		...
		public SumarContext(ExprContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof GramProgListener ) ((GramProgListener)listener).enterSumar(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof GramProgListener ) ((GramProgListener)listener).exitSumar(this);
		}
	}
	public static class NegativoContext extends ExprContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof GramProgListener ) ((GramProgListener)listener).enterNegativo(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof GramProgListener ) ((GramProgListener)listener).exitNegativo(this);
		}
	}
	public static class IdsContext extends ExprContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof GramProgListener ) ((GramProgListener)listener).enterIds(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof GramProgListener ) ((GramProgListener)listener).exitIds(this);
		}
	}
	...
	public static class NumeritoContext extends ExprContext {
		public NumeroContext numero() {
			return getRuleContext(NumeroContext.class,0);
		}
		public NumeritoContext(ExprContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof GramProgListener ) ((GramProgListener)listener).enterNumerito(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof GramProgListener ) ((GramProgListener)listener).exitNumerito(this);
		}
	}
	public static class EntreparContext extends ExprContext {
		public TerminalNode PI() { return getToken(GramProgParser.PI, 0); }
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
		public TerminalNode PD() { return getToken(GramProgParser.PD, 0); }
		public EntreparContext(ExprContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof GramProgListener ) ((GramProgListener)listener).enterEntrepar(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof GramProgListener ) ((GramProgListener)listener).exitEntrepar(this);
		}
	}
	public static class CadenitaContext extends ExprContext {
		public TerminalNode CADENA() { return getToken(GramProgParser.CADENA, 0); }
		public CadenitaContext(ExprContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof GramProgListener ) ((GramProgListener)listener).enterCadenita(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof GramProgListener ) ((GramProgListener)listener).exitCadenita(this);
		}
	}
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case 3:
				{
				_localctx = new EntreparContext(_localctx);
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(188);
				match(PI);
			...
			case 4:
				{
				_localctx = new CadenitaContext(_localctx);
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(192);
				match(CADENA);
			...
			case 5:
				{
				_localctx = new NumeritoContext(_localctx);
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(193);
				numero();
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 2:
						{
						_localctx = new SumarContext(new ExprContext(_parentctx, _parentState));
						pushNewRecursionContext(_localctx, _startState, RULE_expr);
						setState(200);
					...
					case 3:
						{
						_localctx = new CompararContext(new ExprContext(_parentctx, _parentState));
						pushNewRecursionContext(_localctx, _startState, RULE_expr);
						setState(203);
					...
					case 5:
						{
						_localctx = new IncrementarContext(new ExprContext(_parentctx, _parentState));
						pushNewRecursionContext(_localctx, _startState, RULE_expr);
						setState(209);
